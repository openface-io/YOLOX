...
def parse_args() -> argparse.Namespace:
    ...
    args.add_argument(
        "-m", "--model", required=True, type=str, help="Required. Path to an .xml or .onnx file with a trained model."
    )
...
def main():
    ...
    if dets is not None:
        ...
        origin_img = vis(
            origin_img, final_boxes, final_scores, final_cls_inds, conf=args.score_thr, class_names=COCO_CLASSES
        )
